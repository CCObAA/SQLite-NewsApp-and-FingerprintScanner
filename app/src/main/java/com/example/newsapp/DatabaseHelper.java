...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("INSERT INTO Users values(1,'Веселов Михаил Владимирович', 'maikle8632@mail.ru','123',1);");
        sqLiteDatabase.execSQL("INSERT INTO News values(1,'Первая новость', '2022.06.03','Очень интересная новость');");
        sqLiteDatabase.execSQL("INSERT INTO News values(2,'Вторая новость', '2022.06.03','Очень интересная новость');");
    }
